...
from transformers import BertTokenizer, BertForQuestionAnswering, PretrainedConfig
...
def process_data(tweet, selected_text, sentiment, tokenizer, max_len):
    ...
    tweet = tweet.replace('ï¿½', '').replace('WOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO', 'WOOOOOOOOOOOOOO')
    selected_text = selected_text.replace('ï¿½', '').replace('ï', '').replace('WOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO', 'WOOOOOOOOOOOOOO')
...
class TweetModel(transformers.BertPreTrainedModel):
    ...
    def forward(self, ids, mask, token_type_ids):
        ...
        start_logits, end_logits = self.bert(ids, token_type_ids=token_type_ids, attention_mask=mask)
        #####
